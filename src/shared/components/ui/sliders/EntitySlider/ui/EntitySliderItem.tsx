...
const DEFAULT_ROTATES = [-3, 3.5, -6, 5, -3, 3.5, -6, 5];
...
const RepulsionSlide = ({
    ...
    return (
        <motion.div
            ...
            className="relative py-4 select-none max-w-81.25! w-full desktop:max-w-full"
        >
            <motion.div
                animate={{
                    x: repulsionX,
...
const RopeSlide = ({
    ...
    return (
        <motion.div className="relative py-4 select-none max-w-77! w-full desktop:max-w-full" style={{ x: entryX }}>
...
const StaticSlide = ({
    ...
    <div className="relative py-4 select-none max-w-77! w-full desktop:max-w-full">
        <motion.div
